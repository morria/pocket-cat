// The FTX-1's SH width tables as data (docs/passband.md §2.2, researched
// from Hamlib's shared FTX-1/991 tables — yaesu-cat-ftx1.md "Passband
...
public enum PassbandTables {
    ...
    // Ranges (yaesu-cat-ftx1.md "Passband commands").
