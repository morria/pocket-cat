...
///
/// The QMX is a CW/digital radio, so the segments here are CW, FT8 and the
/// standard WSPR dial — there is no SSB entry because the radio has no SSB
/// mode to switch to.
///
...
public final class StationMemory {
    ...
    private enum Key {
        static let channels = "qmx.memories"
        static let stack = "qmx.bandStack"
        static let recents = "qmx.recents"
    }
